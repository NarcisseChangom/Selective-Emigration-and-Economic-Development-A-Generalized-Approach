...
sigma =1.5; psi = (sigma - 1)/sigma;
    Migration_costs_and_model_inversion_IER; 
    InitEqlm_IER;
    Partial_Eqlm_nomig_IER;
    Partial_Eqlm_noselec_IER;
    GenEqlm_SODC_nomig_IER;
    GenEqlm_SODC_noselec_IER; 
    GenEqlm_World_nomig_IER; 
    GenEqlm_World_noselec_IER; 
...
writetable(NetIncomeResponse, 'output\Benchmarksigma15_IER_25.csv', 'Delimiter',',' ,'QuoteStrings', true)
...
NetIncomeResponse = renamevars(NetIncomeResponse,["isoo","Var2","Var3","Var4","Var5","Var6","Var7", ...
                                              ...
                                              ,["iso","NIR6_NM","NIR6_NS","NIR6_PESC","NIR6_PESC4","NIR6_SC", ...
                                                "NIR6_SC4","NIR7_NM","NIR7_NS","NIR7_PESC","NIR7_PESC4", ...
                                                "NIR7_SC","NIR7_SC4","NIR5_NM","NIR5_PESC"]);
writetable(NetIncomeResponse, 'output\Benchmarkmu06_IER_25.csv', 'Delimiter',',' ,'QuoteStrings', true)       
...
NetIncomeResponse = renamevars(NetIncomeResponse,["isoo","Var2","Var3","Var4","Var5","Var6","Var7", ...
                                              ...
                                              ,["iso","NIR6_NM","NIR6_NS","NIR6_PESC","NIR6_PESC4","NIR6_SC", ...
                                                "NIR6_SC4","NIR7_NM","NIR7_NS","NIR7_PESC","NIR7_PESC4", ...
                                                "NIR7_SC","NIR7_SC4","NIR5_NM","NIR5_PESC"]);
writetable(NetIncomeResponse, 'output\Benchmarkmu142_IER_25.csv', 'Delimiter',',' ,'QuoteStrings', true)      
...
NetIncomeResponse = renamevars(NetIncomeResponse,["isoo","Var2","Var3","Var4","Var5","Var6","Var7", ...
                                              ...
                                              ,["iso","NIR6_NM","NIR6_NS","NIR6_PESC","NIR6_PESC4","NIR6_SC", ...
                                                "NIR6_SC4","NIR7_NM","NIR7_NS","NIR7_PESC","NIR7_PESC4", ...
                                                "NIR7_SC","NIR7_SC4","NIR5_NM","NIR5_PESC"]);
writetable(NetIncomeResponse, 'output\BenchmarkzSR_IER_25.csv', 'Delimiter',',' ,'QuoteStrings', true)    
...
writetable(HumanCap, 'output\HumanCap_SR_25.csv', 'Delimiter',',' ,'QuoteStrings', true)
...
zstar = zstar_lic*LIC + zstar_lmic*LMIC + zstar_umic*UMIC + zstar_hic*HIC;
 ...
 %       AVG_NIRp = renamevars(AVG_NIRp,["AVG_NIR6_NM","AVG_NIR7_NM","AVG_NIR6_NS","AVG_NIR7_NS"]...
 %                             ,["AVG_NIR6_NM_p","AVG_NIR7_NM_p","AVG_NIR6_NS_p","AVG_NIR7_NS_p"]);
    GenEqlm_SODC_nomig_IER;
    GenEqlm_SODC_noselec_IER; 
    GenEqlm_World_nomig_IER; 
    GenEqlm_World_noselec_IER; 
...
NetIncomeResponse = renamevars(NetIncomeResponse,["isoo","Var2","Var3","Var4","Var5","Var6","Var7", ...
                                              ...
                                              ,["iso","NIR6_NM","NIR6_NS","NIR6_PESC","NIR6_PESC4","NIR6_SC", ...
                                                "NIR6_SC4","NIR7_NM","NIR7_NS","NIR7_PESC","NIR7_PESC4", ...
                                                "NIR7_SC","NIR7_SC4","NIR5_NM","NIR5_PESC"]);
writetable(NetIncomeResponse, 'output\Pessimistic_IER_25.csv', 'Delimiter',',' ,'QuoteStrings', true)    
...
% Export to CSV 
writetable(WAGESp, 'output\WAGESp_25.csv', 'Delimiter',',' ,'QuoteStrings', true)
...
writematrix(cc_channels, 'output\cc_channelsNM_p_25.csv', 'Delimiter',',' ,'QuoteStrings', true)
...
writematrix(cc_channels_NS, 'output\cc_channelsNS_p_25.csv', 'Delimiter',',' ,'QuoteStrings', true)
...
writetable(THEIL_Pess, 'output\THEIL_Pess_25.csv', 'Delimiter',',' ,'QuoteStrings', true)
